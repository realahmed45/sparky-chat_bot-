                  ...
                  <div className="slider-container">
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          Meet our digital assistant, Sparky! Sparky transforms
                          the way you produce content. Our intelligent
                          algorithms craft compelling material, saving time and
                    ...
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          Sparky customizes templates to your specific design
                          requirements. Now, you dont need to design
                          further.Just tell sparky what you want
                        </p>
                      </div>
                    </div>
                    <div className="slide flex items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          Sparky seamlessly integrates with various platforms,
                          becoming an invaluable asset in your workflow. Content
                          creation becomes more efficient than ever before.
                        </p>
                      </div>
                    </div>
                  </div>
