      ...
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 justify-between items-center sm:pr-4">
              <div className="flex">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  type="button"
                  className="relative inline-flex items-center gap-x-1.5 rounded-md bg-red-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                >
          ...
          <Disclosure.Panel className="md:hidden">
            <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3 sm:pr-4">
              {navigation.map((item) => (
                <Disclosure.Button
                  key={item.name}
                  as="a"
            ...
            <div className="border-t border-gray-700 pb-3 pt-4">
              <div className="flex items-center px-5 sm:px-6 sm:pr-4">
                <div className="ml-3">
              ...
              <div className="mt-3 space-y-1 px-2 sm:px-3 sm:pr-4">
                {userNavigation.map((item) => (
                  <Disclosure.Button
                    key={item.name}
                    as="button"
